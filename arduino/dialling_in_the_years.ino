...
const char song_1958[] PROGMEM = "Heartbreak - Buddy Holly   "; 
...
const char song_1968[] PROGMEM = "Those Were The Days - Mary Hopkin   "; 
const char song_1969[] PROGMEM = "Bad Moon Rising - Creedence Clearwater Revival   ";
 
const char song_1970[] PROGMEM = "Woodstock - Matthews Southern Comfort   "; 
...
const char song_1980[] PROGMEM = "Could you be loved - Bob Marley   "; 
...
const char song_1996[] PROGMEM = "Walk on By - Gabrielle    "; 
